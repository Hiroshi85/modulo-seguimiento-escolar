                        ...
                        <table class="w-full divide-y divide-gray-700 dark:divide-gray-500">
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-center text-md font-semibold text-gray-500 uppercase tracking-wider">Teléfono</th>
                                    <th class="px-6 py-3 text-center text-md font-semibold text-gray-500 uppercase tracking-wider">Genero</th>
                                    <th class="px-6 py-3 text-center text-md font-semibold text-gray-500 uppercase tracking-wider">Correo</th>
                            ...
                            <tbody class="dark:bg-gray-800 divide-y divide-gray-700 dark:bg-gray-900 dark:divide-gray-500">
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">@switch($item->genero)
                                        @case('M')
                                            {{"Masculino"}}
                                            @break
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex">
                                            <a href="{{route('auxiliares.edit', $item->id)}}" class="flex-1 font-medium text-blue-600 dark:text-blue-500 hover:underline"> Editar</a>
                                            <form class="flex-1" action="{{ route('auxiliares.destroy', $item->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
